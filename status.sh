...
# Author  : RIOT
# (C) Copyright 2024-2028 By PRANTAS
# =========================================
...
echo -e "         OWNER : ${GREEN} RIOT ${NC}${YELLOW}(${NC} ${GREEN} STORE  ${NC}${YELLOW})${NC}"
echo -e "       © Copyright By MIFTAH TUNNELING ${YELLOW}(${NC} 2024-2030 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
